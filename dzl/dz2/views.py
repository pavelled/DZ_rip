...
class create_group(FormView):
    ...
    def post(self, request, *args, **kwargs):
        form1 = form.group_form(request.POST)
        if form1.is_valid() and request.FILES.get('picture'):
            ...
            form1.add_error('picture', 'Изображение')
